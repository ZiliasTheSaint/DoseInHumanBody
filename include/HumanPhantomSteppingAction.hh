...
#ifndef HumanPhantomSteppingAction_h
#define HumanPhantomSteppingAction_h 1
...
class HumanPhantomEventAction;
class HumanPhantomPrimaryGeneratorAction;
//////////////
class HumanPhantomSteppingAction : public G4UserSteppingAction
{
  public:
    HumanPhantomSteppingAction();
   ~HumanPhantomSteppingAction();
    void UserSteppingAction(const G4Step*);

 private:
   HumanPhantomConstruction* detector;
   HumanPhantomEventAction*          eventaction; 
   //HumanPhantomPrimaryGeneratorAction* gun;
