...
HumanPhantomPhysicsList::HumanPhantomPhysicsList():  G4VUserPhysicsList()
{
  SetVerboseLevel(1);
}

HumanPhantomPhysicsList::~HumanPhantomPhysicsList()
{
}

void HumanPhantomPhysicsList::ConstructParticle()
{
...
void HumanPhantomPhysicsList::ConstructBosons()
{ 
  // photons
  G4Gamma::GammaDefinition();
}

void HumanPhantomPhysicsList::ConstructLeptons()
{
  // leptons
...
void HumanPhantomPhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
}

void HumanPhantomPhysicsList::ConstructEM()
{
...
void HumanPhantomPhysicsList::SetCuts()
{
