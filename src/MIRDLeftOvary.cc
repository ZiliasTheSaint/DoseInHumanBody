...
G4VPhysicalVolume* MIRDLeftOvary::Construct(const G4String& volumeName,G4VPhysicalVolume* mother, 
...
{ 
 ...
 G4LogicalVolume* logicLeftOvary = new G4LogicalVolume(OneOvary,
  ...
  VOL=LeftOvaryVol;RHO=LeftOvaryDensity;
