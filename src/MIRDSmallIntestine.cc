...
MIRDSmallIntestine::MIRDSmallIntestine()
{
	VOL=1060*cm3;
...
G4VPhysicalVolume* MIRDSmallIntestine::Construct(const G4String&,G4VPhysicalVolume*,
                                          const G4String&, G4bool, G4bool)
{
  ...
  std::map<std::string,smallIntestine_struct> esp = mmc->GetSmallIntestineMap();    
